            ...
            a = (function () {
                ...
                return (
                    ...
                    (e.prototype.init = function (e, t) {
                        (this.$simplepickerWrapper = e.querySelector('.simplepicker-wrapper')),
                    ...
                    (e.prototype.handleIconButtonClick = function (e) {
                        ...
                        if (e.classList.contains('simplepicker-icon-calender')) {
                            ...
                            return (
                                ((c = i('.simplepicker-calender-section')).style.display = 'block'),
                        ...
                        if (
                            ...
                            e.classList.contains('simplepicker-icon-next') && this.render(n.scrapeNextMonth()),
                            e.classList.contains('simplepicker-icon-previous') && this.render(n.scrapePreviousMonth()),
                            t)
                        ) {
